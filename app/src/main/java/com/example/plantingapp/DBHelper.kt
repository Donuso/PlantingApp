...
class DBHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    companion object {
        ...
        private val dropLogPics: String = "DROP TABLE IF EXISTS logPics;"
        private val dropLogTags: String = "DROP TABLE IF EXISTS logTags;"
        private val dropCustomTag: String = "DROP TABLE IF EXISTS customTag;"
        private val dropTodo: String = "DROP TABLE IF EXISTS todo;"
        private val dropLog: String = "DROP TABLE IF EXISTS log;"
        private val dropLogGroup: String = "DROP TABLE IF EXISTS logGroup;"
        private val dropUser: String = "DROP TABLE IF EXISTS user;"
